...
**Check:**
1. GHL_REDIRECT_URI matches embedded app config?
...
# Should match marketplace portal app config
```
...
### External Resources
- [marketplace portal Docs](https://developer.gohighlevel.com/)
...
- ⏳ marketplace portal Submission Needed
